<?php
    include "koneksi.php";
                ...
                if(isset($_POST['proses'])){
                    mysqli_query($con, "insert into tbl_data set
                    id = '$_POST[id]',
                    nama = '$_POST[namacafe]',
                    alamat = '$_POST[alamat]',
                    sosmed = '$_POST[sosmed]',
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  ...
                  <form method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="namacafe" placeholder="Masukkan Nama Cafe" required>
                        </div>

                        <div class="mb-3">
                            <label for="alamat" class="form-label">Alamat</label>
                            <input type="text" class="form-control" name="alamat" placeholder="Masukkan Alamat Cafe" required>
                        </div>

                        <div class="mb-3">
                            <label for="sosmed" class="form-label">Sosmed</label>
                            <input type="text" class="form-control" name="sosmed" placeholder="Masukkan Sosmed Cafe" required> 
                        </div>
